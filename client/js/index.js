...
function UserEvent(type, prm = {}) {
  switch (type) {
    ...
    case 'btnHost':       document.getElementById('create-game')?.classList.remove('hidden'); break;
    case 'btnCancelCreate': document.getElementById('create-game')?.classList.add('hidden'); break;
    case 'btnJoin':       JoinGame();    break;
    case 'menu':          ShowScene('menu'); break;
    case 'btnSettings':   ShowScene('settings'); break;
    case 'btnTutorial':
    case 'btnMenuTutorial': ShowScene('tutorial'); break;
    case 'btnMenuInfo':     ShowScene('info'); break;
    case 'btnMenuSupport':  ShowScene('support'); break;
    case 'btnMenuRoad':     ShowScene('roadmap'); break;
    case 'btnMenuTest':     ShowScene('test'); break;
